        ...
        return (
            <header className="Header">
                ...
                <div className="Header__about-box">
                    ...
                    <a href="https://www.linkedin.com/in/tomchsu/"><i className="fab fa-linkedin Header__icons"></i></a>
                    <a href="https://github.com/thomaschsu/"><i className="fab fa-github-alt Header__icons"></i></a>
                    <a href="mailto:thomaschsu@gmail.com"><i className="fas fa-envelope-open Header__icons"></i></a>
                </div>
            </header>
        )
    }
